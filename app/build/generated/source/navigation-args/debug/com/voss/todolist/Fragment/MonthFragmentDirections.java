...
public class MonthFragmentDirections {
  private MonthFragmentDirections() {
  }

  @NonNull
  public static ActionMonthFragmentToContentFragment actionMonthFragmentToContentFragment(
      @NonNull ArgsToContent ContentArgs) {
    return new ActionMonthFragmentToContentFragment(ContentArgs);
  }

  public static class ActionMonthFragmentToContentFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionMonthFragmentToContentFragment(@NonNull ArgsToContent ContentArgs) {
      if (ContentArgs == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMonthFragmentToContentFragment setContentArgs(@NonNull ArgsToContent ContentArgs) {
      if (ContentArgs == null) {
        throw new IllegalArgumentException("Argument \"ContentArgs\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("ContentArgs", ContentArgs);
    ...
    public int getActionId() {
      return R.id.action_monthFragment_to_contentFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionMonthFragmentToContentFragment that = (ActionMonthFragmentToContentFragment) object;
    ...
    public String toString() {
      return "ActionMonthFragmentToContentFragment(actionId=" + getActionId() + "){"
